...
export class SpaceDevicesPageActionsService {
  ...
  runToggleDevicePowerFlow(selectedDevice: Device): Observable<void> {
    ...
    const nextType =
      selectedDevice.status === 'ONLINE' ? createDeviceCommandType('STANDBY') : createDeviceCommandType('WAKE');
